...
\end{table}
However looking at the histogram it seems like the expected value is approximately at $0$ anyways for all the four distributions.\todo{Kommenter observasjonene, er det kanskje rett at vi kan sette forventningen lik 0?}
...
\begin{figure}
    ...
    \label{fig:roc}
\end{figure}\todo{Jeg skal lage nytt plot der skriften er litt større}
...
\begin{align}
    ...
    \end{cases}
\end{align}\todo{Jeg vet ikke hvordan man skal bevise det med triks som i ligning 25, men jeg vet at det er dette svaret vi skal komme frem til (ligning 26)}
