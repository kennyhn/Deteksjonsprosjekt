...
\begin{align}
    ...
    \end{cases}
\end{align}\todo{Jeg vet ikke hvordan man skal bevise det med triks som i ligning 25, men jeg tror at det er dette svaret vi skal komme frem til (ligning 26) ved å se på variansen til gammafordeling på wikipedia.}
